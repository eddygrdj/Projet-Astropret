...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 25 mars 2025 à 13:37
...
--
-- Base de données :  `projet-astropret2`
--
...
INSERT INTO `membres` (`IDmembre`, `Prénom`, `Nom`, `Role`, `adresse`, `mot_de_passe`, `email`) VALUES
(1, 'eddy', 'graradji', 'admin', 'lycée branly', '123', NULL),
(2, 'mickael', 'BACCAM', 'utilisateur', 'rillieux', '456', NULL),
(3, 'sylvain', 'DEFRANCE', 'utilisateur', 'charly', '789', NULL),
(4, 'ossama', 'talibi', 'utilisateur', 'lycée branly', '147', NULL);
